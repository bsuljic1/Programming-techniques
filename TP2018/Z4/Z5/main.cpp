...
public:
    ...
    {
        for(auto x : ad.studenti) studenti[x.first] = new Student(*x.second);
        for(auto x : ad.laptopi) laptopi[x.first] = new Laptop(*x.second);
    }
    ...
    void RegistrirajNovogStudenta(int brojindeksa, std::string godina, std::string ime, std::string adress, std::string telefon)
    {
        ...
        studenti[brojindeksa] = new Student(brojindeksa, godina, ime, adress, telefon);
    }
